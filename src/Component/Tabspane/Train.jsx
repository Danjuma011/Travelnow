    ...
    <div className=''>
        ...
        <div className='flex justify-between mt-4'>
            ...
            <span className='w-[48%]'>
              ...
              <button disabled={ details.departure === "" || details.arrival === "" || details.departDate === "" || details.class === "" || details.adults === "" || details.children === ""} className='btn bg-[#552AC1] disabled:bg-[#552AC14D]' onClick={handleSubmit}>FIND TRAIN</button>
    </div>
</div>
